...
-- Dumping data for table comaziwa.milk_collections: ~3 rows (approximately)
...
-- Dumping structure for table comaziwa.tax_bands
...
-- Dumping data for table comaziwa.tax_bands: ~0 rows (approximately)
