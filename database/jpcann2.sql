...
-- Dumping data for table ghana_payroll.allowances: ~15 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `attendances` (
  ...
  `date` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `punch_in` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `punch_out` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
-- Dumping data for table ghana_payroll.benefits_in_kinds: ~6 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `company_profiles` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ssni_est` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tel_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `land_line` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dumping data for table ghana_payroll.company_profiles: ~6 rows (approximately)
...
-- Dumping data for table ghana_payroll.contract_types: ~23 rows (approximately)
...
-- Dumping data for table ghana_payroll.emails: ~4 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `email_settings` (
  ...
  `smtp_security` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dumping data for table ghana_payroll.email_templates: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `employees` (
  ...
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `staff_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `branch_shortcode` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `nok_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_admin_configured` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
INSERT INTO `employees` (`id`, `tenant_id`, `name`, `email`, `phone_no`, `staff_no`, `position`, `dob`, `bank_name`, `branch_name`, `branch_shortcode`, `account_no`, `created_at`, `updated_at`, `password`, `ssn`, `contract_type`, `nok_name`, `nok_phone`, `address`, `is_admin_configured`) VALUES
	(13, 4, 'JONATHAN PRINCE CANN', 'j.cann@jpcannassociates.com', '+233241121761', 'JPC1001', 'CEO', '1980-11-03', 'ECOBANK', 'Ring Road', '4006', '400645878952', '2023-11-03 10:54:29', '2024-02-06 08:28:10', '$2y$10$NrGaSle4Syz8ihCDPm7pSOkQQNSV4O/4KQ5VeOngwymNvGJPhQ0Iy', 'CO1254879', 1, 'JO GYATA', '+23345698745', '58 NSAWAM ROAD', 0),
	(14, 4, 'Sandys Lartey', 'sandys.lartey@jpcannassociates.com', '0504249800', 'JPC1004', 'IT Manager', '1987-05-12', 'Stanbic', 'NIA', '10021', '400400456', '2023-11-03 13:09:44', '2023-11-03 13:11:14', '$2y$10$XiZ96N3ygy6.kemLmwrxX.e9rczWMIPr4vizaoa4oJQ.7luuLITc2', 'CB389854652', 5, 'Uncle Ebo', '+233302974302', '58 Nsawam Road', 0),
	(15, 4, 'Tracey Cann', 'tracey.cann@jpcannassociates.com', '0501335818', 'JPC1002', 'Director, Business Development', '1981-06-10', 'UBA', 'Ring', '7005', '876985224', '2023-11-03 13:14:47', '2023-11-03 13:14:47', '$2y$10$ZY66.hF0TaqwhxApbYoVYurfJ.LLifn5JneBVwaoLUH7/pvC4PWCK', 'CC45258577', 0, 'Kirtsy', '0501626969', '51 Lower McCarthy Hill', 0),
	(22, 4, 'Benjamin Laryea', 'benjamin.laryea@jpcannassociates.com', '0501457253', 'JPC1009', 'Account Officer', '1992-06-09', 'Stanbic', 'Makola', '1007', '94000975852', '2023-11-21 11:48:15', '2024-02-12 11:34:12', '$2y$10$SikWJ6oE5Ik2KVah7cFd8uNqC/7q8isrTMg6aC0lqXqaqycgHiVaa', 'KY54587655', 6, 'Joshua Laryea', '0272623315', 'A66/5 Chorkor Chemunaa', 0),
	...
	(151, 109, 'Joel Toffey', 'louistoffegee@gmail.com', '0558313155', '3094453', 'IT DEPARTMENT', '2007-03-20', 'ADB', 'Kokomelmel', '2236', '1254477963', '2024-01-16 12:08:21', '2024-02-06 11:41:21', '$2y$10$FR65AOB1xtYxxamoWVHVYepmKcdQodsaampdzlTwmOqbMTSV2Arv6', '12255', 40, 'Louis Toffey', '0202368643', 'No.58 NSAWAM ROAD', 0),
	(152, 109, 'Sena Opoku', 'senaopoku@gmail.com', '0558314156', '6730305', 'accounting department', '2001-03-16', 'CBG', 'Circle', '22365', '12544779635', '2024-01-16 12:15:14', '2024-01-16 12:15:14', '$2y$10$nSuEMJ0zP/8xtaEHe6mCoOeeRusy72rJcBxd9y6jDRdn.hKJACGgu', '5598', 0, 'Louis Toffee', '0202368643', 'No.58 NSAWAM ROAD', 0),
	(155, 4, 'Elma Johnson', 'elma.johnson@jpcannassociates.com', '+233501637305', 'JPC1008', 'Senior Business Development Officer', '', 'Stanbic', 'Accra Main', '190101', '9040000094778', '2024-01-16 17:18:40', '2024-01-16 17:18:40', '$2y$10$Je2s24Xjbh5DRHQq.fO9Ue7PTisbA3o8lctmdqlTVl4XuR6eVygjW', 'JP100001545', 0, 'Micheal Johnson', 'Micheal Johnson', NULL, 0),
	(156, 4, 'Prince Amazing Diamond', 'prince.diamond@jpcannassociates.com', '+233504249700', 'JPC1099', 'Senior Business Development Officer', '', 'Stanbic', 'NIA', '190105', '9040004359512', '2024-01-16 17:18:43', '2024-01-16 17:18:43', '$2y$10$7wY5iHrwxEldCBlrqG9to.W/5AmNbjhKeTZ6V1fl7Y5nOCNriU8Jy', 'JP100001546', 0, 'Bless Kofi Diamond', 'Bless Kofi Diamond', NULL, 0),
	...
	(158, 4, 'Emmanuel Brako Apau', 'emmanuel.brakoapau@jpcannassociates.com', '+233501454082', 'JPC1011', 'IT Support Officer', '', 'Stanbic', 'Accra Mall', '190104', '9040009529556', '2024-01-16 17:18:46', '2024-02-05 15:05:14', '$2y$10$3FgTmRijNBNTuaMgW9YmyeK1aHcrOgCrgGsW9QYgisLDqHsWHuEda', 'GHA712274553', 0, 'Samuel Odei Apau', 'Samuel Odei Apau', NULL, 0),
	...
	(160, 4, 'Ato Amakye Sam', 'atoamakye.sam@jpcannassociates.com', '+233501569736', 'JPC1014', 'Business Advisory Officer', '', 'Stanbic', 'Tema Community 1', '190118', '9040008697471', '2024-01-16 17:18:49', '2024-02-05 14:42:44', '$2y$10$jeq6hobfaoaXN2xBUKVU3u.a43cZflldRtnqlrKpBTn9gFe20lkry', 'GHA717809634', 0, 'Esi Kumi Sam', 'Esi Kumi Sam', NULL, 0),
	(161, 4, 'Evans Archer Fevlo', 'evansarcher.fevlo@jpcannassociates.com', '+233501622081', 'JPC1015', 'Multi Media and Web Designer', '', 'Access', 'Sefwi Wiawso', '280403', '0301628115571', '2024-01-16 17:18:50', '2024-02-08 09:08:21', '$2y$10$XUakXYnuwHpDuCUvWyNVj.HDIMYxDtoYv4fbIEoLFn2coAfaE2Fzm', 'JP100001549', 0, 'Mary Fevlo', 'Mary Fevlo', NULL, 0),
	(162, 4, 'Mary Arum Arum', 'mary.arum@jpcannassociates.com', '+233500788300', 'JPC1016', 'Training Support Officer', '', 'GCB', 'Circle', '40127', '1391010040912', '2024-01-16 17:18:51', '2024-02-09 09:22:05', '$2y$10$60smgspeRKS2BDWA8q0UyuDQnh./XnErFITy46tgjWy87I73Aduj6', 'GHA-727404962', 0, 'Houma Ruth Charles', 'Houma Ruth Charles', NULL, 0),
	...
	(171, 4, 'Francis Tagoe', 'francis.tagoe@jpcannassociates.com', '0265375346', 'JPC19988', 'Assistant Manager, Business Development', '1989-12-04', 'Stanbic', 'NIA', '10021', '9040001245687', '2024-01-29 11:23:42', '2024-02-12 11:19:46', '$2y$10$3AzpjfMJIXxCBQ55hefRsuJuKj5vnVUYMnKUM48oox1UrIstdwZHy', 'JP10066666', 0, 'Vida', 'Aggie', '62 Old Man Road', 0),
	(172, 4, 'Edmund Toffey', 'edmund.toffey@jpcannassociates.com', '0202368640', 'JPC1045', 'NSP IT', '2001-01-30', 'ADB', 'SPINTEX', '5001', '2546669988', '2024-01-29 12:16:58', '2024-02-09 09:17:25', '$2y$10$nn75ayAWdsH/TM1.aVOs7uFHZPECE6BwpFOASVSCuFHSlhx9KLyNm', 'CX125455455', 5, 'EDWIN TOFFEY', '0240128940', '75 MINISTRIES ROAD', 0),
	(174, 127, 'Daniel Mutuku', 'daniel.mutuku404@gmail.com', '0717576900', '5204679', 'Software Developer', '2024-02-12', 'Equity', 'Nairobi', '063', '0392439434043', '2024-02-12 06:46:39', '2024-02-12 07:04:52', '$2y$10$RGGKM8N.RThVCBi4FYMtVOpV2YzSFInpbQ3d2fq2hHLx7n8Suczuy', 'SDSK44NVKD3', 0, 'Fred', '0717576900', 'Westcom Point, Westlands', 0),
	(189, 172, 'Mwalyo', 'marionmbithi@gmail.com', '0795974284', '4487588', 'IT officer', '2007-06-20', 'BANK', 'Nairobi', '215', '000401223345', '2024-02-16 00:00:47', '2024-02-16 16:40:39', '$2y$10$tXexRU9csHQVaqZUn3.q/O8p/0JWjLwAAyb73UnG96faQrzDrsepa', '98766783333', 49, 'Majesty', '0747954284', 'Moi Avenue, Nairobi-Kenya.', 0),
	(190, 172, 'Philemon', 'phinleymark724@gmail.com', '0747954284', '1545590', 'IT officer', '2024-01-30', 'BANK', 'Nairobi', '215', '1401223345', '2024-02-16 08:08:41', '2024-02-16 16:40:54', '$2y$10$Pi3pFsOhO7pxBUpqHqNIpu5eQk87FgnUXOTVYUxAbcAY4VMj9cqRq', '45456756', 51, 'Majesty', '0729303852', 'Moi Avenue, Nairobi-Kenya.', 0);
...
CREATE TABLE IF NOT EXISTS `employee_assigned_permissions` (
  ...
  CONSTRAINT `employee_assigned_permissions_permission_id_foreign` FOREIGN KEY (`permission_id`) REFERENCES `permissions` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dumping data for table ghana_payroll.employee_permissions: ~32 rows (approximately)
INSERT INTO `employee_permissions` (`id`, `name`, `created_at`, `updated_at`) VALUES
	(1, 'view.leave', NULL, NULL),
	(2, 'request.leave', NULL, NULL),
	(3, 'approve.leave', NULL, NULL),
	(4, 'decline.leave', NULL, NULL),
	(5, 'delete.leave', NULL, NULL),
	(6, 'view.training', NULL, NULL),
	(7, 'create.training', NULL, NULL),
	(8, 'edit.training', NULL, NULL),
	(9, 'invite.individual', NULL, NULL),
	(10, 'invite.department', NULL, NULL),
	(11, 'delete.training', NULL, NULL),
	(12, 'view.project', NULL, NULL),
	(13, 'create.project', NULL, NULL),
	(14, 'edit.project', NULL, NULL),
	(15, 'delete.project', NULL, NULL),
	(16, 'view.task', NULL, NULL),
	(17, 'create.task', NULL, NULL),
	(18, 'edit.task', NULL, NULL),
	(19, 'delete.task', NULL, NULL),
	(20, 'view.emails', NULL, NULL),
	(21, 'create.template', NULL, NULL),
	(22, 'edit.template', NULL, NULL),
	(23, 'delete.template', NULL, NULL),
	(24, 'view.expenses', NULL, NULL),
	(25, 'approve.expense', NULL, NULL),
	(26, 'delete.expense', NULL, NULL),
	(27, 'view.contract', NULL, NULL),
	(28, 'upload.contract', NULL, NULL),
	(29, 'delete.contract', NULL, NULL),
	(30, 'create.company.profile', NULL, NULL),
	(31, 'create.company.settings', NULL, NULL),
	(32, 'edit.email.settings', NULL, NULL);
...
-- Dumping data for table ghana_payroll.expense_types: ~10 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `leaves` (
  ...
  `remaining_days` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `reasons` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
-- Dumping data for table ghana_payroll.migrations: ~64 rows (approximately)
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(65, '2024_02_19_014958_add_field_to_employees_table', 29),
	(66, '2024_02_19_053242_create_employee_permissions_table', 29),
	(67, '2024_02_19_053447_create_employee_assigned_permissions_table', 29);
...
-- Dumping data for table ghana_payroll.non_statutory_deductions: ~4 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `pay_slips` (
  ...
  `allowances` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `benefits` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `statutory_deductions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `nonstatutory_deductions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dumping data for table ghana_payroll.pay_slips: ~11 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `projects` (
  ...
  `project_team` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table ghana_payroll.projects: ~5 rows (approximately)
...
-- Dumping data for table ghana_payroll.statutory_deductions: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `subscriptions` (
  ...
  `type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'monthly',
...
-- Dumping data for table ghana_payroll.subscriptions: ~0 rows (approximately)
...
-- Dumping data for table ghana_payroll.tasks: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tax_bands` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `min` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `max` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `trainings` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `vendor` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `time` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dumping data for table ghana_payroll.trainings: ~0 rows (approximately)
...
-- Dumping data for table ghana_payroll.training_requests: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `agent_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
-- Dumping data for table ghana_payroll.users: ~126 rows (approximately)
