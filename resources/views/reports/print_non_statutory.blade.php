            ...
            <div class="">	
                <table class="table table-striped custom-table" border="1" id="">
                    ...
                    <tbody>
                        ...
                        @php 
                            $result = array_filter(json_decode($key->nonstatutory_deductions, true), function ($item) use ($non_ststutory) {
                                return $item['id'] == $non_ststutory;
                            });
