                ...
                <table class="table table-striped custom-table" id="paye_reports_table">
                    <thead>
                        <tr>
                            <th colspan="11">
                                ...
                                <p class="text-center">
                                    <h5 class="text-center">GENERAL PAYSLIP REPORT - {{date('M Y',strtotime($pay_period))}}</h5>
                                </p>
                            </th>                        
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{@num_format($key->basic_salary*0.135)}}</td>
                            <td>{{@num_format($key->basic_salary*0.05)}}</td>
                    ...
                    <tfoot>
                        <tr class="table-secondary" style="font-weight:bold">
                            ...
                            <td>{{@num_format($grandtier1)}}</td>
                            <td>{{@num_format($grandtier2)}}</td>
                            <td>{{@num_format($grandpaye)}}</td>
                            <td>{{@num_format($grandNet)}}</td>
                        </tr>
                        <tr>
                            <td colspan="11">
                                <p>I certify that I have deducted the correct amount of tax from the total remuneration of each member of the staff employed by me/us for the month of {{date('M Y',strtotime($pay_period))}}</p>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
