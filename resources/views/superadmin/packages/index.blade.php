    ...
    <div class="col-12 col-md-6 col-lg-4 d-flex">
        <div class="card flex-fill">
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item"><strong>Monthly Price:</strong> GHS {{number_format($module->price)}}</li>
              <li class="list-group-item"><strong>Annual Price:</strong> GHS {{number_format($module->annual_price)}}</li>
            ...
            <div class="d-flex justify-content-center mt-3 mb-2">
              @if(usercan('edit.package'))
                <a class="btn btn-success mr-2 edit-button btn-sm" data-action="{{ url('packages/edit', [$module->id]) }}" href="#"><i class="fa fa-pencil"></i> Edit</a>
              @endif
              
              @if($module->is_system ==0 && usercan('delete.package'))
                <a class="btn btn-primary delete-reload-button btn-sm" data-action="{{ url('packages/delete', [$module->id]) }}" href="#"><i class="fa fa-trash"></i> Delete</a>
              @endif
