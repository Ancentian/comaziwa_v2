<div class="modal-dialog modal-dialog-centered modal-md" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="assign_permissions_form" action="{{url('/superadmin/assign-permissions/'.$role->id)}}" method="POST">
                @csrf
                ...
                <div class="row">                    
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('add.system.admin',$permissions) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('assign.roles',$permissions) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('delete.system.admin',$permissions) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('edit.system.admin',$permissions) ? 'checked' : '' }}>
                ...
                <div class="row">                    
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('add.client',$permissions) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('assign.agent',$permissions) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('edit.client',$permissions) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('extend.expiry.dates',$permissions) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('edit.user.package',$permissions) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('delete.client',$permissions) ? 'checked' : '' }}>
                ...
                <div class="row">                    
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('add.package',$permissions) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('delete.package',$permissions) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="checkbox">
                            ...
                            {{ in_array('edit.package',$permissions) ? 'checked' : '' }}>
