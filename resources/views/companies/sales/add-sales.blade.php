...
<div class="row">
    <div class="col-md-12">
        <form id="add_store_sales" action="{{ url('sales/store-sales') }}" method="POST">
            @csrf
            <div class="row">
                ...
                <div class="form-group col-sm-4">
                    ...
                    <select class="form-control select" name="farmer_id" id="farmer_id_select" required>
                        ...
                        @foreach($farmers as $key)
                            <option value="{{ $key->id }}">{{ $key->fname.' '.$key->lname.' - '.$key->farmerID }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-sm-4">  
            ...
            <div class="row">
                {{-- <div class="form-group col-sm-4">
                    ...
                    <input type="text" class="form-control" name="farmer_id" id="farmer_id" readonly>
                </div> --}}
                <div class="form-group col-sm-4">
                    <label>Code</label>
