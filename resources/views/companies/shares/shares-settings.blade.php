                    ...
                    <div class="row"> 
                        <div class="col-sm-6" hidden>
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{substr(mt_rand(1000000, 9999999), 0, 7)}}" name="shares_code" required >
...
$(document).ready(function(){
    ...
    $('#add_shares_settings_form').on('submit', function (e) {
        ...
        $.ajax({
            url: '{{ url('shares/store-shares-settings') }}',
            method: 'POST',
            data: formData,
...
$(document).ready(function(){
    shares_settings_table = $('#shares_settings_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "{{url('shares/all-shares-settings')}}",
                data: function(d){
