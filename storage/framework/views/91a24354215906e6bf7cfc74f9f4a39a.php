<?php if($type == 'employee_registration'): ?>
    <p>
        ...
        <br>
            Welcome to <?php echo e(company()->mycompany()->name); ?>! We are thrilled to have you on board. Your self-service account is ready for you to access all our HR and payroll features. Here are your login details:
        <br>
...
<?php elseif($type == 'subscription_paid'): ?>
    <p>
        ...
        <br>
            You can access your account and manage your subscription at <a href="<?php echo e(url('dashboard/subscriptions')); ?>">Manage subscriptions</a>. If you have any questions or need assistance, please contact our support team at info@ghpayroll.net .
        <br>
            Best regards,
        <br>
        <b><?php echo e(env('APP_NAME')); ?></b>
...
<?php elseif($type == 'password_change'): ?>
    <p>
        Dear <b><?php echo e($data['name']); ?></b>,
        <br>
            This is a confirmation that your password for <?php echo e($data['company']); ?> has been successfully changed. If you did not initiate this change, please contact us immediately at info@ghpayroll.net
        <br>
...
<?php elseif($type == 'subscription_renewal'): ?>
    <p>
        ...
        <br>
            To continue enjoying our services, no action is required; we'll automatically renew your subscription. If you wish to make any changes, please log in to your account at <a href="<?php echo e(url('dashboard/subscriptions')); ?>">Manage subscriptions</a>. For questions or assistance, reach out to our support team at info@ghpayroll.net 
        <br>
...
<?php elseif($type == 'subscription_reminder'): ?>
    <p>
        ...
        <br>
            To renew your subscription, please log in to your account at <a href="<?php echo e(url('dashboard/subscriptions')); ?>">Manage subscriptions</a>. If you have any questions or need assistance, feel free to contact our support team at info@ghpayroll.net.
        <br>
            Best regards,
        <br>
            <b><?php echo e(env('APP_NAME')); ?></b>!
...
<?php elseif($type == 'leave_applied'): ?>
    <p>
        Dear <b><?php echo e($data['name']); ?></b>,
        <br>
            We have received your leave request for <?php echo e($data['leave_type']); ?> starting from <b><?php echo e($data['start_date']); ?></b> to <b><?php echo e($data['end_date']); ?></b>. Your request is now being reviewed by our HR team. You will be notified once a decision is made.
        <br>
...
<?php endif; ?>
<p>
    <img src="<?php echo e(asset('img/ghana.png')); ?>" width="80" height="40">
    <strong>Powered By JPCann</strong>
</p><?php /**PATH /home/ghpayroll/base/resources/views/emails/transactional_emails_body.blade.php ENDPATH**/ ?>