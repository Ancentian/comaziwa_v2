...
<div class="header">
   ...
   <div class="header-left">
    ...
    <?php if(session('is_admin') == 0 && optional(auth()->guard('employee')->user())->is_admin_configured == 1): ?>
        <h3><a class="btn btn-danger" href="<?php echo e(url('staff/set-as-admin')); ?>">Login As Admin</a></h3>
    <?php endif; ?>    
    <?php if(session('is_admin') == 1): ?>
        <h3><a class="btn btn-warning" href="<?php echo e(url('staff/set-as-staff')); ?>">Login As Staff</a></h3>
    <?php endif; ?> 
    </div>
    <!-- /Header Title -->
...
<!-- /Header --><?php /**PATH /home/ghpayroll/base/resources/views/companies/staff/layout/navbar.blade.php ENDPATH**/ ?>