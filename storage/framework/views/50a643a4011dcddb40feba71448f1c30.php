...
<div class="page-header">
    <div class="row align-items-center">
        ...
        <div class="col-auto float-right ml-auto">
            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#staff_send_mail"><i class="fa fa-plus"></i> Send Mail</a> &nbsp;
            <a href="#" class="btn btn-info" data-toggle="modal" data-target="#staff_bulk_send_mail"><i class="fa fa-plus"></i> Send Bulk</a>
        </div>
    </div>
</div>
<!-- /Page Header -->
...
<div id="staff_send_mail" class="modal custom-modal fade" role="dialog">
...
<div id="staff_bulk_send_mail" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Send Email</h5>
            ...
            <div class="modal-body">
                    ...
                    <form id="staff_send_bulky_mail_form"  enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <label>Choose From Template:</label>
...
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/communications/index.blade.php ENDPATH**/ ?>