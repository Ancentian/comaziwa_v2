    ...
    <div class="row align-items-center">
        <div class="col">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Farmers Monthly Report</li>
            </ul>
        </div>
...
$(document).ready(function(){
    ...
    collected_milk_table = $('#collected_milk_table').DataTable({
        ...
        serverSide: false,
        ajax: {
            url : "<?php echo e(url('analysis/farmer-monthly-report')); ?>",
            data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/reports/farmer-monthly-report.blade.php ENDPATH**/ ?>