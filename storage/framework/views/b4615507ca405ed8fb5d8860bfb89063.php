<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="update_expense_request" action="<?php echo e(url('trainings/update-status', [$training->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\laragon\www\payroll\resources\views/companies/trainings/status.blade.php ENDPATH**/ ?>