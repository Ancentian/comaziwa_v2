...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .internet-alert {
                display: none;
                position: fixed;
                top: 75px; /* Adjusted to move the alert lower */
                left: 50%;
    ...
    <body>
        <!-- Notification Alert -->
        <div id="internet-alert" class="alert internet-alert" role="alert" style="display: none;">
            <!-- Initial message will be updated by JavaScript -->
        </div>
