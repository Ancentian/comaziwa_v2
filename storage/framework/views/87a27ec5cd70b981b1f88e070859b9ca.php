...
$(document).ready(function(){
    ...
    $('#add_asset_form').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo e(url('assets/store-asset-category')); ?>',
            method: 'POST',
            data: formData,
...
$(document).ready(function(){
        asset_categories_table = $('#asset_categories_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('assets/asset-categories')); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/assets/categories/index.blade.php ENDPATH**/ ?>