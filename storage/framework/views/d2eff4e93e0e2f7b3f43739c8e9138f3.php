                                    ...
                                    <div class="task-board-header">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item edit-button" data-action="<?php echo e(url('staff/edit-task', [$key->id])); ?>" href="#"><i class="fa fa-pencil"></i> Edit</a>
...
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/tasks/all_staff_tasks.blade.php ENDPATH**/ ?>