        ...
        <section class="dash-section">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="stats-info">
                        <h6>Today</h6>
                        <h4><?php echo e(number_format($attendance_summary['days'], 2)); ?></h4>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="stats-info">
                        <h6>This Week</h6>
                        <h4><?php echo e(number_format($attendance_summary['weeks'], 2)); ?><span></span></h4>
                    </div>
                </div>
            </div>
        </section>
            ...
            <section>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="stats-info">
                            <h6>Total Tasks</h6>
                            <h4><?php echo e(number_format($completed)); ?></h4>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="stats-info">
                            <h6>Pending Tasks</h6>
                            <h4><?php echo e(number_format($inprogress)); ?></h4>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="stats-info">
                            <h6>Total Projects</h6>
                            <h4><?php echo e(number_format($projects)); ?></h4>
                        </div>
                    </div>
                </div>
            ...
            <section>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="stats-info">
                            <h6>Completed</h6>
                            <h4><?php echo e(number_format($completedTraining)); ?></h4>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="stats-info">
                            <h6>Outstanding</h6>
                            <h4><?php echo e(number_format($outstandingTraining)); ?></h4>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="stats-info">
                            <h6>Invited</h6>
                            <h4><?php echo e(number_format($invitedTraining)); ?></h4>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="stats-info">
                            <h6>Applied</h6>
                            <h4><?php echo e(number_format($appliedTraining)); ?></h4>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/index.blade.php ENDPATH**/ ?>