<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="edit_course_form" action="<?php echo e(url('staff/decline-invite', [$training->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/trainings/decline-invite.blade.php ENDPATH**/ ?>