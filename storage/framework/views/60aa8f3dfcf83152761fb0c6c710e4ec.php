...
$(document).ready(function(){
    consumer_categories_table = $('#consumer_categories_table').DataTable({
        ...
        serverSide: false,
        ajax: {
            url : "<?php echo e(url('milk-management/consumer-categories')); ?>",
            data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/milk_management/consumers/categories.blade.php ENDPATH**/ ?>