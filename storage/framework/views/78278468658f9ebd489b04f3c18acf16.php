                ...
                <form id="addColectionCenter">
                    ...
                    <div class="form-group">
                        ...
                        <select class="select" name="grader_id" required>
                            ...
                            <?php $__currentLoopData = $graders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<!-- /Delete Benefits Modal --><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/partials/centers/index.blade.php ENDPATH**/ ?>