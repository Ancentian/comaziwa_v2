...
<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="post_payslip_form" action="<?php echo e(url('/employees/generate-monthly-payslip')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<script>
    ...
    </script><?php /**PATH C:\laragon\www\payroll\resources\views/employees/generate_monthly_payslip.blade.php ENDPATH**/ ?>