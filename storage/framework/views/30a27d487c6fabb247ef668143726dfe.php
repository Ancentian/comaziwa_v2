    ...
    <div class="row align-items-center">
        <div class="col">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Statutory Deductions</li>
            </ul>
        </div>       
    </div>
</div>
...
<form id="printStatutoryDed" action="<?php echo e(url('payslip-exports/print-statutory')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-sm-4">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <select class="form-control" name="statutory" id="allowance">
                    <?php $__currentLoopData = $statutory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="table-responsive">	
            <table class="table table-striped custom-table" id="statutory_report_table">
                <thead>
                    <tr>                        
                        <th>Name</th>
                        <th>Position</th>
...
$(document).ready(function(){
        ...
        $('#pay_period, #allowance').change(function() {
            statutory_report_table.ajax.reload();
        });
    ...
    function setAction(action) {
        ...
        $(document).ready(function() {
        $('#printStatutoryDed').submit(function(e) {
            e.preventDefault();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/payslip_reports/statutory_deductions.blade.php ENDPATH**/ ?>