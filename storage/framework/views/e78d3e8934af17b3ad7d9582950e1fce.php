...
<?php if(!auth()->user()->package_id && auth()->user()->type == 'client'): ?>
<?php if($pp > 0): ?>
    <script>
...
<?php if((strtotime(auth()->user()->expiry_date) - time()) <= 0 && auth()->user()->type == 'client'): ?>
<?php if($pp > 0): ?>
<script>
    $(document).ready(function() {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ghpayroll/base/resources/views/dashboard/subscriptions.blade.php ENDPATH**/ ?>