...
$(document).ready(function() {
    ...
    var all_payments_table = $('#all_payments_table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(url('payments/bank-list')); ?>",
            data: function(d) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/payments/bank-list.blade.php ENDPATH**/ ?>