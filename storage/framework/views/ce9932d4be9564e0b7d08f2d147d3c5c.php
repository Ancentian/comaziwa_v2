...
$(document).ready(function(){
    ...
    all_sales_table = $('#all_sales_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('analysis/farmer-sales-report')); ?>" + "/" + farmerId,
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/reports/farmer-sales-report.blade.php ENDPATH**/ ?>