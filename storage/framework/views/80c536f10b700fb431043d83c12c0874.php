...
$(document).ready(function(){
        benefit_report_table = $('#benefit_report_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('payslip-reports/benefits')); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/payslip_reports/benefits.blade.php ENDPATH**/ ?>