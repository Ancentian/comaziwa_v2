...
<div class="page-header">
    <div class="row align-items-center">
        ...
        <div class="col-auto float-right ml-auto">
            <a href="<?php echo e(url('staff/add-milk-collection')); ?>" class="btn btn-info" ><i class="fa fa-plus"></i> Add Milk Collection</a> &nbsp;
...
$(document).ready(function(){
    ...
    collected_milk_table = $('#collected_milk_table').DataTable({
        ...
        serverSide: false,
        ajax: {
            url : "<?php echo e(url('staff/all-milk-collection')); ?>",
            data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/staff/milk-collection/index.blade.php ENDPATH**/ ?>