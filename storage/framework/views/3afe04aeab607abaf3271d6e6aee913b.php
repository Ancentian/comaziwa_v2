                ...
                <table class="table table-striped custom-table" id="paye_reports_table">
                    <thead>
                        <tr>
                            <th colspan="9">
                                ...
                                <p class="text-center">
                                    <h5 class="text-center">NET PAY TO BANK REPORT - <?php echo e(date('M Y',strtotime($pay_period))); ?></h5>
                                </p>
                            </th>                        
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($key->bank_name); ?></td>
                            <td><?php echo e($key->branch_shortcode); ?></td>
                            <td><?php echo e($key->branch_name); ?></td>
...
<?php /**PATH /home/ghpayroll/base/resources/views/reports/print_bank_net_pay.blade.php ENDPATH**/ ?>