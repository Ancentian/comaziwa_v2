...
<form id="printPaye" action="<?php echo e(url('payslip-exports/print-bank-net-pay')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-md-4">
...
$(document).ready(function(){
        paye_report_table = $('#paye_report_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('staff/bank-net-pay')); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/payslip_reports/bank-net-pay.blade.php ENDPATH**/ ?>