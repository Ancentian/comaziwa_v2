...
<div class="page-header">
    <div class="row align-items-center">
        ...
        <div class="col-auto float-right ml-auto">
            <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_staff_leave"><i class="fa fa-plus"></i> Add Leave</a>
        </div>
    </div>
</div>
<!-- /Page Header -->
...
<!-- Add Leave Modal -->
<div id="add_staff_leave" class="modal custom-modal fade" role="dialog">
...
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/leaves/all_staff_leaves.blade.php ENDPATH**/ ?>