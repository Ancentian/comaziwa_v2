...
<div class="row">
    <div class="col-md-3">
        <div class="stats-info">
            <h6>Total Expense</h6>
            <h4><?php echo e(number_format($total_requests, 2, '.', ',')); ?></h4>
        </div>
    </div>
    <div class="col-md-3">
        <div class="stats-info">
    ...
    <div class="col-md-3">
        <div class="stats-info">
            <h6>Paid Requests</h6>
            <h4><?php echo e($paid); ?> <span></span></h4>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="table-responsive">
            <table class="table table-striped custom-table" id="companies_expenses_table">
                <thead>
                    <tr>
...
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/expenses/all_expenses.blade.php ENDPATH**/ ?>