<div class="modal-dialog modal-dialog-centered modal-md" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="edit_deduction_type" action="<?php echo e(url('deductions/update-deduction-type', $deduction->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-sm-12">  
...
</script><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/deductions/edit_type.blade.php ENDPATH**/ ?>