...
$(document).ready(function(){
        statutory_report_table = $('#statutory_report_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('payslip-reports/statutory')); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/payslip_reports/statutory_deductions.blade.php ENDPATH**/ ?>