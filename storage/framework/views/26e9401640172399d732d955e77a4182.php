...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="table-responsive">	
            <table class="table table-striped custom-table" id="sales_report_table">
                <thead>
                    <tr>
...
$(document).ready(function(){
    ...
    sales_report_table = $('#sales_report_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('analysis/sales-monthly-report')); ?>",
                data: function(d){
            ...
            columns: [
                ...
                {data: 'sales_month', name: 'sales_month'},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/reports/sales-monthly-report.blade.php ENDPATH**/ ?>