...
<div class="page-header">
    <div class="row align-items-center">
        ...
        <?php if(staffCan("create.project")): ?>
...
<form id="printProjects" class="mb-2" action="<?php echo e(url('projects/print-project')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <div class="row">
...
<div class="row">
    <div class="col-md-12">
        <div class="table-responsive">
            <table class="table table-striped custom-table mb-0" id="projects_table">
                <thead>
                    <tr>
                        <th>Title</th>
                        <th>Start Date</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/projects/index.blade.php ENDPATH**/ ?>