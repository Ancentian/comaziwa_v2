...
$(document).ready(function(){
        paye_report_table = $('#paye_report_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('staff/paye-tax')); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/payslip_reports/paye-tax.blade.php ENDPATH**/ ?>