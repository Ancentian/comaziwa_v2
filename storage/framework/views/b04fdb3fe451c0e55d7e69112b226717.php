...
<form id="printBenefits" action="<?php echo e(url('payslip-exports/print-benefits')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-sm-4">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <select class="form-control" name="benefit" id="allowance">
                    <?php $__currentLoopData = $benefit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="table-responsive">	
            <table class="table table-striped custom-table" id="benefit_report_table">
                <thead>
                    <tr>
...
$(document).ready(function(){
        ...
        $('#pay_period, #allowance').change(function() {
            benefit_report_table.ajax.reload();
        });
    ...
    $(document).ready(function() {
        $('#printBenefits').submit(function(e) {
            e.preventDefault();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/payslip_reports/benefits.blade.php ENDPATH**/ ?>