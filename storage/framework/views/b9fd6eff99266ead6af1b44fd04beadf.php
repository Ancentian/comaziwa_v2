                                    ...
                                    <div class="task-board-header">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item edit-button" data-action="<?php echo e(url('staff/editTask', [$key->id])); ?>" href="#"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                            </div>
                                        </div>                                        
                                    </div>
            ...
            <div class="modal-body">
                <form id="add_task_form">
                    ...
                    <div class="form-group" hidden>
                        ...
                        <input type="text" name="tenant_id" value="<?php echo e($tenant_id); ?>" class="form-control">
                    ...
                    <div class="form-group" hidden>
                        ...
                        <input type="text" name="assigned_to" value="<?php echo e($employee_id); ?>" class="form-control">
                        <span class="modal-error invalid-feedback" role="alert"></span>
                    </div>
                    <div class="form-group">
...
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/tasks/index.blade.php ENDPATH**/ ?>