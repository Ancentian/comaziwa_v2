<div class="modal-dialog modal-dialog-centered modal-md" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="edit_inventory" action="<?php echo e(url('inventory/update-inventory-stock', $inventory->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>    
                <div class="row">
...
</script><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/inventory/add_stock.blade.php ENDPATH**/ ?>