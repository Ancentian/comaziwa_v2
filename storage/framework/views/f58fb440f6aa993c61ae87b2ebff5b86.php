...
<!-- /Page Header -->
<form id="printAllowances" action="<?php echo e(url('staff/print-allowances')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-sm-4">
...
$(document).ready(function(){
        allowance_report_table = $('#allowance_report_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('staff/allowances')); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/payslip_reports/allowances.blade.php ENDPATH**/ ?>