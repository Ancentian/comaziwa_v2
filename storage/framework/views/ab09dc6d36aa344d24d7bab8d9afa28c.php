<div class="modal-dialog modal-dialog-centered modal-md" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="edit_task_form" action="<?php echo e(url('tasks/update', [$task->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\laragon\www\payroll\resources\views/companies/tasks/edit.blade.php ENDPATH**/ ?>