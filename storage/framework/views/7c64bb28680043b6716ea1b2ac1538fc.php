<div class="modal-dialog modal-dialog-centered modal-md" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="<?php echo e(url('staff/update-certificate', [$training->id])); ?>" class="edit_form" method="POST" id="upload_certificate" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-sm-12">
...
</script><?php /**PATH /home/ghpayroll/base/resources/views/companies/staff/trainings/upload_certificate.blade.php ENDPATH**/ ?>