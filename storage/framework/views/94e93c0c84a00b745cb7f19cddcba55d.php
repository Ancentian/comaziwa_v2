<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="add_employee_form" action="<?php echo e(url('/employees/create')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php
                ...
                <?php if($totalStaff < $package->staff_no): ?>
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6" hidden>
                            <div class="form-group">
                                ...
                                <input class="form-control" name="password" type="password" value="<?php echo e($pass); ?>" required>
                                <span class="modal-error invalid-feedback" role="alert"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="staff_no" type="text" value="<?php echo e(substr(mt_rand(1000000, 9999999), 0, 7)); ?>" name="staff_no" required>
                                <span class="modal-error invalid-feedback" role="alert"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <?php echo e($package->name); ?> package only allows maximum of <strong><?php echo e($package->staff_no); ?></strong> employees! Contact the admin.
...
<script>
        ...
        $('#add_employee_form').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    window.location.href = "<?php echo e(url('/employees/generateinitialPayslip/')); ?>" + "/"+response.id;
                },
    ...
    </script><?php /**PATH C:\laragon\www\comaziwa\resources\views/employees/create.blade.php ENDPATH**/ ?>