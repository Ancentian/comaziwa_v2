...
<script>
    ...
    $(document).on('click', '.view-transaction-details', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('sales/transaction-details')); ?>"+"/"+ transactionId,
            method: 'GET',
...
</script><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/sales/view-transaction.blade.php ENDPATH**/ ?>