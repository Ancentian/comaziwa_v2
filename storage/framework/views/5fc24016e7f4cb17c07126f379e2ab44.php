          ...
          <div class="col-md-9">
            ...
            <div class="tab-content" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active" id="v-pills-centers" role="tabpanel" aria-labelledby="v-pills-allowances-tab">
                    <?php echo $__env->make('companies.partials.centers.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
              </div>

              <div class="tab-pane fade" id="v-pills-coop-banks" role="tabpanel" aria-labelledby="v-pills-coop-banks-tab">
                <?php echo $__env->make('companies.partials.banks.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
              </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/settings.blade.php ENDPATH**/ ?>