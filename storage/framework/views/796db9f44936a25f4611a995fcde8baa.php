...
$(document).ready(function(){
        tier_two_table = $('#tier_two_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('staff/tier-two')); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/payslip_reports/tier_two.blade.php ENDPATH**/ ?>