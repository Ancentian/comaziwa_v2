...
$(document).ready(function(){
        nonstatutory_report_table = $('#nonstatutory_report_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('payslip-reports/non-statutory')); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/payslip_reports/nonstatutory_deductions.blade.php ENDPATH**/ ?>