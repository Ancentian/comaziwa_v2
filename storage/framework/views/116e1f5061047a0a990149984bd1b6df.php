            ...
            <ul>
                ...
                <?php endif; ?>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a href="<?php echo e(url('milk-management/consumption-list')); ?>"> List </a></li>
                            <li><a href="<?php echo e(url('milk-management/consumers-calendar')); ?>"> Calender </a></li>
                            <li><a href="<?php echo e(url('milk-management/consumer-categories')); ?>"> Categories </a></li>
                        </ul>
                    </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a href="<?php echo e(url('accounting/balance-sheet')); ?>"> Balance Sheet </a></li>
                            <li><a href="<?php echo e(url('accounting/profit-loss')); ?>"> Profit & Loss </a></li>
                            <li><a href="<?php echo e(url('accounting/accounting-reports')); ?>"> Accounting Reports </a></li>
                            <li><a href="<?php echo e(url('accounting/income-statement')); ?>"> Income Statement </a></li>
                        </ul>
                    </li>
