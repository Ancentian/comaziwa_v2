...
$(document).ready(function(){
        paye_report_table = $('#paye_report_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('payslip-reports/bank-net-pay')); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/payslip_reports/bank-net-pay.blade.php ENDPATH**/ ?>