<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="update_leave_form" action="<?php echo e(url('leaves/updateStatus', [$leave->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\laragon\www\payroll\resources\views/employees/leaves/approve.blade.php ENDPATH**/ ?>