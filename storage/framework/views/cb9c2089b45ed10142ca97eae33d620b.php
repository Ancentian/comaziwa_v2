...
$(document).ready(function(){
    ...
    collected_milk_table = $('#collected_milk_table').DataTable({
        ...
        serverSide: false,
        ajax: {
            url : "<?php echo e(url('milkCollection/all-milk-collection')); ?>",
            data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/milkcollection/index.blade.php ENDPATH**/ ?>