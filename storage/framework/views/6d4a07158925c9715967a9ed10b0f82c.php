                ...
                <table class="table table-striped custom-table" id="paye_reports_table">
                    <thead>
                        <tr>
                            <th colspan="11">
                                ...
                                <p class="text-center">
                                    <h5 class="text-center">GENERAL PAYSLIP REPORT - <?php echo e(date('M Y',strtotime($pay_period))); ?></h5>
                                </p>
                            </th>                        
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(number_format($total_allowance, 2, '.', ',')); ?></td>
                            <td><?php echo e(number_format($total_benefit, 2, '.', ',')); ?></td>
                            <td><?php echo e(number_format($total_gross, 2, '.', ',')); ?></td>
                            <td><?php echo e(number_format($key->basic_salary*0.135, 2, '.', ',')); ?></td>
                            <td><?php echo e(number_format($key->basic_salary*0.05, 2, '.', ',')); ?></td>
                    ...
                    <tfoot>
                        <tr class="table-secondary" style="font-weight:bold">
                            ...
                            <td><?php echo e(number_format($grandAllowance, 2, '.', ',')); ?></td>
                            <td><?php echo e(number_format($grandBenefit, 2, '.', ',')); ?></td>
                            <td><?php echo e(number_format($grandGross, 2, '.', ',')); ?></td>
                            <td><?php echo e(number_format($grandtier1, 2, '.', ',')); ?></td>
                            <td><?php echo e(number_format($grandtier2, 2, '.', ',')); ?></td>
                            <td><?php echo e(number_format($grandpaye, 2, '.', ',')); ?></td>
                            <td><?php echo e(number_format($grandNet, 2, '.', ',')); ?></td>
                        </tr>
                        <tr>
                            <td colspan="11">
                                <p>I certify that I have deducted the correct amount of tax from the total remuneration of each member of the staff employed by me/us for the month of <?php echo e(date('M Y',strtotime($pay_period))); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
...
<?php /**PATH /home/ghpayroll/base/resources/views/reports/print_payee_report.blade.php ENDPATH**/ ?>