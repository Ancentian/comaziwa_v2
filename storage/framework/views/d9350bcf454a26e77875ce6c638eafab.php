...
<div class="page-header">
    <div class="row align-items-center">
        ...
        <div class="col-auto float-right ml-auto">
            <a href="#" class="btn btn-info" data-toggle="modal" data-target="#add_unit"><i class="fa fa-plus"></i> Add Unit</a> &nbsp;
        </div>
    </div>
</div>
<!-- /Page Header -->
...
<div class="row">
    <div class="col-md-12">
        <div class="table-responsive">	
            <table class="table table-striped custom-table" id="units_table">
                <thead>
                    <tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="unit_code" required>
                                <span class="modal-error invalid-feedback" role="alert"></span>
                            </div>
                        </div>
                        <div class="col-sm-12">
...
$(document).ready(function(){
    ...
    $('#add_unit_form').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo e(url('inventory/store-unit')); ?>',
            method: 'POST',
            data: formData,
...
$(document).ready(function(){
        units_table = $('#units_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('inventory/units')); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/inventory/units/index.blade.php ENDPATH**/ ?>