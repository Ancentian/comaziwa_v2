    ...
    <div class="row align-items-center">
        <div class="col">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Farmer Deductions Report</li>
            </ul>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="table-responsive">	
            <table class="table table-striped custom-table" id="deductions_report_table">
                <thead>
                    <tr>
                        <th>Farmer</th>
                        <th>Center</th>
...
$(document).ready(function(){
    ...
    var farmerId = currentUrl.split('/').pop();

    $('#daterange').daterangepicker({
        opens: 'bottom',
        ranges: ranges
    }, function(start, end, label) {
        deductions_report_table.ajax.reload();
    });

    $(document).on('change', ' #farmer_id', function () {
        deductions_report_table.ajax.reload();
    })
    deductions_report_table = $('#deductions_report_table').DataTable({
            <?php echo $__env->make('layout.export_buttons', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            processing: true,
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('analysis/farmers-deductions-report')); ?>" + "/" + farmerId,
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/reports/farmer-deduction-report.blade.php ENDPATH**/ ?>