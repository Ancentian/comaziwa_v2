...
<form id="print_nonStatutory" action="<?php echo e(url('payslip-exports/print-non-statutory')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-sm-4">
...
$(document).ready(function(){
        nonstatutory_report_table = $('#nonstatutory_report_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('staff/non-statutory')); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/payslip_reports/nonstatutory_deductions.blade.php ENDPATH**/ ?>