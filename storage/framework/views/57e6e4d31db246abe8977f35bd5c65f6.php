...
<script>
    ...
    //         $.ajax({
    //             url: "<?php echo e(route('accounting.balance-sheet')); ?>",
    //             type: 'GET',
    //             data: {
    ...
    $(document).ready(function() {
        $('#pay_period').on('change', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    console.log("Success:", response.deductions.total_individual_amount);
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/accounting/balance-sheet.blade.php ENDPATH**/ ?>