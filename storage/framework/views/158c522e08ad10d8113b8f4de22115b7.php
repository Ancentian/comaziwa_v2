...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="income-statement-title">Income Statement for the month of Feb 2024</h4>
                <div class="row">
                    ...
                    <div class="col-sm-6 m-b-20">
                        <div class="invoice-details">
                            <h3 class="text-uppercase">Income Statement #2024-02</h3>
                ...
                <div class="row">
                    <div class="col-sm-12 m-b-20">
                        <div>
                            <h4 class="m-b-10"><strong>Operating Income</strong></h4>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td><strong>Operating Income</strong> <span class="float-right"><strong>$2,000</strong></span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 m-b-20">
                        <div>
                            <h4 class="m-b-10"><strong>Other Income and Expenses</strong></h4>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td><strong>Interest Income</strong> <span class="float-right">$200</span></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Interest Expense</strong> <span class="float-right">($100)</span></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Total Other Income and Expenses</strong> <span class="float-right"><strong>$100</strong></span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div>
                            <h4 class="m-b-10"><strong>Net Profit Before Tax</strong></h4>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td><strong>Net Profit Before Tax</strong> <span class="float-right"><strong>$2,100</strong></span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="col-sm-12 m-b-20">
                        <div>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td><strong>Tax Expense</strong> <span class="float-right">$500</span></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Total Tax</strong> <span class="float-right"><strong>$500</strong></span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div>
                            <h4 class="m-b-10"><strong>Net Profit After Tax</strong></h4>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td><strong>Net Profit After Tax</strong> <span class="float-right"><strong>$1,600</strong></span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/accounting/income-statement.blade.php ENDPATH**/ ?>