...
<div class="page-header">
    <div class="row align-items-center">
        ...
        <div class="col-auto float-right ml-auto">
            <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_statutoryDed"><i class="fa fa-plus"></i> Create Statutory Deduction</a>
        </div>
    </div>
</div>
<!-- /Page Header -->
...
<div class="row">
    <div class="col-md-12">
        <div class="table-responsive">	
            <table class="table table-striped custom-table mb-0" id="statutory_deductions_table">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Type</th>
...
<!-- Add Allowance Modal -->
<div id="add_statutoryDed" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Create Statutory Deduction</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="statutoryDeduction">
                    <?php echo csrf_field(); ?>
...
<!-- /Delete Statutory Deduction Modal --><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/partials/deductions/statutoryDeductions.blade.php ENDPATH**/ ?>