...
<div class="page-header">
    <div class="row align-items-center">
        ...
        <div class="col-auto float-right ml-auto">
            <a href="<?php echo e(route('add-consumption')); ?>" class="btn btn-danger" ><i class="fa fa-download"></i> Add Consumption</a> &nbsp;
...
$(document).ready(function() {
    $('#add_consumer_cat').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(url('milk-management/store-category')); ?>',
            method: 'POST',
            data: formData,
...
$(document).ready(function(){
    consumptions_table = $('#consumptions_table').DataTable({
        ...
        serverSide: false,
        ajax: {
            url : "<?php echo e(url('milk-management/all-consumptions')); ?>",
            data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/milk_management/consumers/consumption-list.blade.php ENDPATH**/ ?>