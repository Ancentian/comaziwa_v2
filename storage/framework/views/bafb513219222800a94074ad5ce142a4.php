...
<script>
    $(document).ready(function(){
        ...
        function loadData(){
            ...
            $.ajax({
                url: "<?php echo e(url('/staff/staff-attendances')); ?>",
                type: 'GET',
                data: data,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('companies.staff.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\payroll\resources\views/companies/staff/attendance/staff_attendances.blade.php ENDPATH**/ ?>