    ...
    <div class="row align-items-center">
        <div class="col">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Deductions Report</li>
            </ul>
        </div>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="table-responsive">	
            <table class="table table-striped custom-table" id="analysis_deductions_table">
                <thead>
                    <tr>
                        <th>Farmer</th>
                        <th>Center</th>
    ...
    $('#add_farmer_form').on('submit', function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                form.reset();
                analysis_deductions_table.ajax.reload();
...
$(document).ready(function(){
    ...
    $(document).on('change', ' #center_id, #farmer_id', function () {
        ...
        analysis_deductions_table = $('#analysis_deductions_table').DataTable({
            <?php echo $__env->make('layout.export_buttons', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            processing: true,
            serverSide: false,
            ajax: {
                url : "<?php echo e(url('analysis/monthly-deductions-report')); ?>",
                data: function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\comaziwa\resources\views/companies/reports/monthly-deductions-report.blade.php ENDPATH**/ ?>